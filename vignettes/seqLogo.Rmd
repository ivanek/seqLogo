...
```{r seqLogo4, fig.height=4, fig.width=6, fig.cap="Sequence logo with user specified colors."}
...
__Use of the `r CRANpkg("grid")` package__. The `r CRANpkg("grid")` package is
used to draw the sequence letters from graphical primitives. We note that this 
should make it easy to extend the package to amino acid sequences. 
